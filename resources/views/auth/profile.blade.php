        ...
        <div class="container-xl">
            ...
            <form action="{{ route('profile.update') }}" method="POST" class="card" autocomplete="off">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label required">{{ __('Nom') }}</label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="{{ __('Nom') }}" value="{{ old('name', auth()->user()->name) }}" required>                        
                    </div>
                    @error('name')
                    ...
                    <div class="mb-3">
                        <label class="form-label required">{{ __('Adresse email') }}</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label required">{{ __('Nouveau mot de passe') }}</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label required">{{ __('Confirmer le mot de passe') }}</label>
